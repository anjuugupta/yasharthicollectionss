const styles = {
    ...
    price:"font-[500] text-[16px] text-[#4573d5] pl-3 mt-[-4px] line-through",
    shop_name:"pt-3 text-[15px] text-blue-400 pb-3",
    active_indicator:"absolute bottom-[-27%] left-0 h-[3px] w-full bg-[#1885f2]",
    button: 'w-[150px] bg-[#2e37f0] text-gray h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer',
    cart_button: "px-[20px] h-[38px] rounded-[20px] bg-[#3b44f6] flex items-center justify-center cursor-pointer",
